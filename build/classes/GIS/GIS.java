...
import GIS.filehandling.FileHandler;
import GIS.geometry.*;
import GIS.drawing.*;
import java.awt.*;
...
/**
 * Generates the GIS, serves as connection between user input and functionalities
 * @author Lukas, Fuad, Keneuoe, Ayokunle
 */
public class GIS extends JFrame implements ActionListener  {
    
    // The GIS object

    /** The GIS object which is invoked in the main method
     *
     */
    public static GIS gis;

    /** The Content of the GIS, all Points, Polylines and Polygons actualy drawn
     *
     */
    public Content c;
    

    /** The Drawing Panel of the GIS where Geometries defined in the Content are drawn
     *
     */
    public DrawingPanel p;
    
    
    /** The File Handler for Database and CSV interaction.
     *
     */
    ...
    /** Constructor invokes a new Content and DrawingPanel object and its properties. 
     * It defines the action handlers in the DrawingPanel for the drawing of objects, zooming and panning.
     * Stores new drawn objects in the Content and can select drawn objects if "selectFeatures" mode is active.
     * @author Lukas
     */
    public GIS(){
        super("GIS"); //heading
    ...
    /** Invokes a new File Handler form
     * @author Keneuoe
     */
    public void createFileHandler(){
        fh = new FileHandler();
        fh.setTitle("Connect to DB");
        // in center of screen
    ...
    /**
     * Update the GIS Content after a DB or CSV import.
     * @param cFH a Content received from the filehandling, Content of the GIS (this.c)
     * will be overwritten with it
     * @author Lukas
     */
    public void setContent(Content cFH) {
        this.c = cFH;
        p.setPan(factor, horizontal, vertical);
        p.updateContent(c);
        p.repaint();
    ...
    /** 
     * Sets the layout of the GIS.
     * @author Fuad, Ayokunle
     */
    ...
    /**
     * Invokes an object of the Class GIS and set it's layout.
     * @param args -
     */
